 ...
 * @category Operator
 * @param right
 * @typeparam TLeft The object type of the left data source.
 * @typeparam TLeftKey The key type of the left data source.
 * @typeparam TRight The object type of the right data source.
 * @typeparam TRightKey The key type of the right data source.
 * @typeparam TDestination The resulting object which is combined from the left and right objects.
